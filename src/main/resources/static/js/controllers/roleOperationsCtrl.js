(function (document, window, $) {
  ...
  App.RoleOperationsController = function (baseUrl, startDate, endDate, page, perPage, sort, sortColumn, searchTerm) {
    ...
    this.elements.startDatepicker = $('.role-operations-start-datepicker');
    this.elements.endDatepicker = $('.role-operations-end-datepicker');
   ...
   */
  App.RoleOperationsController.prototype.configureDatePickers = function (startDate, endDate) {
  ...
  App.RoleOperationsController.prototype.exportCSV = function () {
    var url = this.baseUrl + '/reports/roleOperation/csv?startDate=' + this.originalStartDate + '&endDate=' + this.originalEndDate;
    window.location.replace(url);
  };

  App.RoleOperationsController.prototype.searchReport = function () {
    ...
    var url = this.baseUrl + '/reports/roleOperation?start=' + from + '&end=' + to + '&page=' + 0 + '&perPage=' + size + '&sort=' + sortAux[1] + '&sortColumn=' + sortAux[0] + '&searchTerm=' + search;
    window.location.replace(url);
  };

  App.RoleOperationsController.prototype.next = function () {
    var url = this.baseUrl + '/reports/roleOperation?start=' + this.originalStartDate + '&end=' + this.originalEndDate + '&page=' + parseInt(this.page + 1) + '&perPage=' + this.perPage + '&sort=' + this.sort + '&sortColumn=' + this.sortColumn + '&searchTerm=' + this.searchTerm;
    window.location.replace(url);
  };

  App.RoleOperationsController.prototype.previous = function () {
    var url = this.baseUrl + '/reports/roleOperation?start=' + this.originalStartDate + '&end=' + this.originalEndDate + '&page=' + parseInt(this.page - 1) + '&perPage=' + this.perPage + '&sort=' + this.sort + '&sortColumn=' + this.sortColumn + '&searchTerm=' + this.searchTerm;
    window.location.replace(url);
  };

  App.RoleOperationsController.prototype.buildTable = function () {
   ...
   */
  App.RoleOperationsController.prototype.columnHighlightEventsInit = function () {
   ...
   */
  App.RoleOperationsController.prototype.init = function () {
    this.buildTable();
  };
